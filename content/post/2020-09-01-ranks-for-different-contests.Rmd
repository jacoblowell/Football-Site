...
Team <-  Underdog_Ownership %>% filter(Position =="QB") %>% group_by(Player, Stacked) %>%  
  ...
  scale_color_tq() + labs(title = "Underdog QB Exposure"  , y = "Quarterback")   + scale_x_continuous(labels = dollar)
...
Rankings_2020 <- read_csv("~/Desktop/BestBall/Data/Fantasy_Pros_Ranks/FantasyPros_2019_Draft_Overall_Rankings.csv") %>%  mutate(Season = 2020)
